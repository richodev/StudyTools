...
class HttpClient:
    ...
    def RunGet(self, url: str, data: dict = None, params: dict = None, headers: dict = None) -> Any:
    ...
    def RunPost(self, url: str, data: dict = None, params: dict = None, headers: dict = None) -> Any:
